...
var ChangePlatformTemplate = function() {
    return '<select class="input" data-placeholder-text="Choose Platform"></select><button class="btn btn-primary save">Save</button><button class="btn cancel">Cancel</button>';
};
