...
function caseIgnoreSubstringsMatch(f, q) {
    ...
    filters.push(sprintf('(%s:caseIgnoreSubstringsMatch:=*%s*)', f, q));
    return filters;
}
...
function list(req, res, next) {
    ...
    if (req.query.q) {
        ...
        filters = filters.concat(caseIgnoreSubstringsMatch('company', q));
        filters = filters.concat(caseIgnoreSubstringsMatch('givenname', q));
        filters = filters.concat(caseIgnoreSubstringsMatch('sn', q));
        filters = filters.concat(caseIgnoreSubstringsMatch('login', q));
        filters = filters.concat(caseIgnoreSubstringsMatch('email', q));
