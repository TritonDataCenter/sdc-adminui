...
function getUser(req, res, next) {
    ...
    req.sdc.ufdsMaster.getUser(login, function(err, user) {
        if (err) {
            return next(err);
        }
...
function getLimits(req, res, next) {
    req.sdc.ufdsMaster.listLimits(req.params.uuid, function(err, limits) {
        if (err) {
...
function addLimit(req, res, next) {
    var user = req.params.uuid;
    req.sdc.ufdsMaster.addLimit(user, req.body, function(err, limit) {
        if (err) {
...
function updateLimit(req, res, next) {
    ...
    req.sdc.ufdsMaster.updateLimit(user, params, function(err, limit) {
        if (err) {
...
function deleteLimit(req, res, next) {
    ...
    req.sdc.ufdsMaster.deleteLimit(user, limit, function(err) {
        if (err) {
